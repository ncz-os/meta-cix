...
SUMMARY = "Linux kernel for Cix Sky1 / CP8180 (official cixtech patches on v7.1.1)"
DESCRIPTION = "Mainline Linux v7.1.1 + cixtech/cix-linux-main patches-7.0 forward-ported \
to 7.1.1 (NCZ patches-7.1). Authoritative CIX vendor patch set. NPU/VPU via external DKMS."
SECTION = "kernel"
...
LINUX_VERSION = "7.1.1"
KERNEL_LOCALVERSION = "-cix-sky1-official"
PATCHTOOL = "git"
PV = "${LINUX_VERSION}+cix-official"
KBRANCH = "linux-7.1.y"
